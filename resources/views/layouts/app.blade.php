...
<head>
    ...
    <title>{{ config('app.name', 'KTPM') }}</title>
    ...
    <script src="{{ asset('js/mo.js') }}" defer></script>
    ...
    <link href="{{ asset('css/mo.css') }}" rel="stylesheet">
</head>
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">{{ config('app.name', 'KTPM') }}</a>
